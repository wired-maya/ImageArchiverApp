...
//TODO:
// - make settings read from file and so on
...
namespace ImageArchiverApp
{
    class Settings
    {
        ...
        public void ReadFromFile()
        {
            try
            {
                var settings = JsonConvert.DeserializeObject<Dictionary<string, Dictionary<string, bool>>>(File.ReadAllText(@"DefaultSettings.json"));
